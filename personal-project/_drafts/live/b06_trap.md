...
## [body3] body
The second time I tried a method called Graphify, which turns everything you know into a graph. It looks very good in an Instagram reel. When I actually used it I could not see the use for me. It looks very beautiful, but it does not mean anything to me. It does not produce any insight from my notes. I am using this for research, not for coding, and I do not have a large codebase that needs that kind of thing.
