...
(() => {
  ...
  const PAGES = [
    ...
    { id: "week-8",            url: "reading-response/week-8/",             desc: "reading response · week 8" },
    { id: "week-9",            url: "reading-response/week-9/",             desc: "reading response · week 9" },
    { id: "week-11",           url: "reading-response/week-11/",            desc: "reading response · week 11 (latest)" },
  ...
  const ALIASES = {
    ...
    latest: "week-11", project: "personal-project", pkm: "personal-project",
